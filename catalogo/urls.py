...
from .views.category_views import category_list, category_create, category_update, category_delete, category_toggle
from .views.product_views import (
    product_list, product_create, product_update, product_delete, product_toggle,
    product_details, product_edit_modal
)
...
urlpatterns = [
    ...
    path('produtos/<int:pk>/editar/modal/', product_edit_modal, name='product_edit_modal'),
